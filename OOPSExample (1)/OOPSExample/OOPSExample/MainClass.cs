...
namespace OOPSExample
{
    class MainClass
    {
        static void Main(string[] args)
        {
            ...
            //string[] teacher1SkillSet = { "JavaScript", "ASP.NET", "C#", "Python" };
            //Teacher teacher1 = new Teacher(teacher1SkillSet, "Vaibhav", 11);
            //teacher1.GetSkillSetDetails();

            //Reference of child class holds object of Parent class
            RightAngleTraingleShape rightAngleTraingleShape = (RightAngleTraingleShape)new TriangleShape(3.1, 5.5);
            rightAngleTraingleShape.GetHypotenuseSide();

            //Reference of parent class having a child class object
            TriangleShape triangleShape = new RightAngleTraingleShape(1.1, 2.4);
            //We would be only able to access the parent class member function
